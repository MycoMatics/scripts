...
fast5_subset --input $VSC_DATA_VO_USER/HPC-ampseq-course/dataset/fast5 --save_path $VSC_DATA_VO_USER/HPC-ampseq-course/dataset/fast5_subset --read_id_list sequencing_summary_barcode01_only_andheaders.txt --batch_size 1000 --recursive