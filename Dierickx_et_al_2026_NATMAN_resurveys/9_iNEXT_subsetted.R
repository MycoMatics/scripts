...
out_dir <- "tlsr_clsr_outputs_subset"
...
stopifnot(exists("X_use_subset"))
stopifnot(exists("meta_use_subset"))

X_full <- as.data.frame(X_use_subset)
meta_full <- as.data.frame(meta_use_subset)
